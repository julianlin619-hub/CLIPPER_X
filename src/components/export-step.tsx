...
export default function ExportStep({ versionWords, fileName, filePath, duration, fps = 30, fcpxmlPath, transcript = [] }: Props) {
        ...
        <button
          onClick={async () => {
            ...
            try {
              ...
              const suffix = versionWords.length > 1 ? `_master_${versionWords.length}v` : "_master";
